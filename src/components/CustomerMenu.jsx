        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-[100] px-4 pb-4 pointer-events-none">
            <div className="flex items-center justify-around bg-neutral-900/80 backdrop-blur-2xl border border-white/10 p-2 rounded-3xl shadow-2xl pointer-events-auto max-w-sm mx-auto">
                ...
                <button
                    ...
                    className="flex flex-col items-center gap-1 p-2 rounded-2xl active:bg-white/5 transition-all flex-1"
                >
                ...
                <button
                    onClick={onOpenCart}
                    className="relative flex flex-col items-center gap-1 p-2 rounded-2xl active:bg-white/5 transition-all flex-1"
                >
                ...
                <button
                    ...
                    className="flex flex-col items-center gap-1 p-2 rounded-2xl active:bg-[#ce112d]/20 transition-all flex-1"
                >

        ...
        <section className="pt-10 border-t border-neutral-100">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-xl bg-[#ce112d]/10 text-[#ce112d] flex items-center justify-center">
            ...
            <div className="flex flex-wrap items-stretch gap-3 md:gap-5">
                {recentProducts.map((prod) => {
                    ...
                    return (
                        <div
                            ...
                            className="w-[calc(50%-6px)] sm:w-[180px] md:w-[210px] shrink-0 bg-white rounded-2xl p-2.5 md:p-3.5 border border-neutral-100/90 shadow-sm hover:shadow-xl hover:border-red-100 hover:-translate-y-1 transition-all duration-300 cursor-pointer group flex flex-col justify-between"
                        >
                            <div>
                                <div className="relative aspect-[4/5] rounded-xl overflow-hidden bg-neutral-50 mb-3">
                                    <img
                            ...
                            <div className="flex items-center justify-between pt-3 border-t border-neutral-50 mt-2">
                                <span className="text-xs md:text-sm font-black text-[#ce112d] whitespace-nowrap">৳{price}</span>
                                <div className="w-6 h-6 rounded-lg bg-neutral-50 flex items-center justify-center text-neutral-400 group-hover:bg-[#ce112d] group-hover:text-white transition-all shrink-0">
                                    <ArrowRight size={12} />
                                </div>
                            </div>
                        </div>

  ...
  '/about-us': {
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl mt-8">
          <h4 className="text-rose-600 font-bold mb-2 text-sm uppercase tracking-wider">আমাদের প্রতিশ্রুতি</h4>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl flex flex-col items-center text-center space-y-3">
            ...
            <p className="text-zinc-900 font-bold text-xs">বারইয়ারহাট, মীরসরাই, চট্টগ্রাম</p>
          </div>
        </div>
      </div>
    )

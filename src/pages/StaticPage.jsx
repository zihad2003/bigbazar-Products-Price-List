...
const pageData = {
    ...
    content: (
      <div className="space-y-6">
        <p className="text-zinc-700 leading-relaxed text-sm md:text-base font-medium">
          চট্টগ্রাম জেলার মীরসরাই উপজেলার বারইয়ারহাট পৌরসভার জমিরদার প্লাজার ২য় তলায় অবস্থিত <strong className="text-zinc-900 font-bold">Big Bazar</strong> পুরো পরিবারের কেনাকাটার জন্য অত্র অঞ্চলের সবচেয়ে বিশ্বস্ত ও জনপ্রিয় ফিক্সড প্রাইস রিটেইল শপ। ৬৫,০০০-এরও বেশি সোশ্যাল মিডিয়া ফলোয়ারের আস্থা অর্জিত এই প্রতিষ্ঠানে পরিবারের প্রতিটি মানুষের প্রয়োজনীয় পোশাক—এমনকি কাপড়ের থান, গজ কাপড় ও জায়নামাজ পর্যন্ত এক ছাদের নিচে পাওয়া যায়।
        </p>
        ...
        <div className="p-6 bg-gradient-to-br from-rose-50 to-red-50 border border-rose-200/80 rounded-3xl space-y-3 shadow-sm">
          <div className="flex items-center gap-2 text-[#ce112d]">
            <ShoppingBag size={20} />
            <h4 className="font-bold text-base md:text-lg">সিগনেচার ওয়েডিং সেকশন: "বিয়ের সাজনি" (Biyer Sajani)</h4>
          </div>
          <p className="text-zinc-650 text-xs md:text-sm leading-relaxed">
            Big Bazar-এর প্রধানতম আকর্ষণ হলো এক্সক্লুসিভ ওয়েডিং কালেকশন <strong>"বিয়ের সাজনি"</strong>। কনের জন্য বর্তমানে সবচেয়ে জনপ্রিয় কারচুপি জামদানি, ঢাকাই জামদানি, বিলাসবহুল কাতান, জর্জ্রেট, হেভি স্টোন ওয়ার্ক, জিমুজি, ডিজিটাল প্রিন্ট শাড়ি এবং পাকিস্তানি ও ইন্ডিয়ান ভাইরালাইজড লং পার্টি ড্রেস, সারারা ও গারারার বিশাল কালেকশন রয়েছে। পাশাপাশি বরের সাজের জন্য শেয়ারওয়ানি, প্রিমিয়াম পাঞ্জাবি, ব্লেজার এবং ফর্মাল-ক্যাজুয়াল পোশাকের সমৃদ্ধ আয়োজন রয়েছে।
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 bg-zinc-50 border border-zinc-200/60 rounded-2xl space-y-2">
            ...
            <p className="text-zinc-600 text-xs leading-relaxed">
              ছোটদের জন্য ১-৫ বছর এবং ৫-১৫ বছর বয়সী ছেলে ও মেয়েদের আলাদা সেকশন রয়েছে। নারীদের জন্য সব ধরনের বোরকা, আবায়ায়, কুটি বোরকা, হিজাব, নিকাব ও পেটিকোট।
            </p>
          </div>
          <div className="p-5 bg-zinc-50 border border-zinc-200/60 rounded-2xl space-y-2">
            <h5 className="font-bold text-zinc-900 text-xs md:text-sm text-[#ce112d]">জেন্টস ও হোম ডেকোর</h5>
            <p className="text-zinc-600 text-xs leading-relaxed">
              পুরুষদের ড্রপ শোল্ডার টি-শার্ট, পোলো, শার্ট, গাবার্ডিন ও শর্টস। এছাড়া গৃহস্থালির সাজসজ্জার জন্য বেডশিট, পর্দা, মশারি, জায়নামাজ ও গজ কাপড়।
            </p>
          </div>
        </div>
        ...
        <div className="p-6 bg-zinc-900 text-white rounded-3xl space-y-2">
          ...
          <p className="text-zinc-300 text-xs md:text-sm font-medium">
            অনলাইনে অর্ডার করলে মীরসরাই উপজেলার বাসিন্দারা পাচ্ছেন <strong>১০০% ফ্রি হোম ডেলিভারি (Free Home Delivery)</strong>! এছাড়া সারা বাংলাদেশে ক্যাশ অন ডেলিভারি সুবিধাতো থাকছেই।
          </p>
        </div>
      </div>
    )
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl flex flex-col items-center text-center space-y-3">
            ...
            <p className="text-zinc-900 font-bold text-xs">২য় তলা, জমিরদার প্লাজা, বারইয়ারহাট পৌরসভা, মীরসরাই, চট্টগ্রাম</p>
          </div>
        </div>
      </div>
    )
  ...
  '/faq': {
    ...
    content: (
      <div className="space-y-6">
        {[
          { q: 'বিগ বাজার বারইয়ারহাট শোরুমের ঠিকানা কোথায়?', a: 'আমাদের শোরুমটি চট্টগ্রাম জেলার মীরসরাই উপজেলার বারইয়ারহাট পৌরসভার জমিরদার প্লাজার ২য় তলায় অবস্থিত।' },
          { q: 'মীরসরাই এলাকায় হোম ডেলিভারি কি ফ্রি?', a: 'হ্যাঁ! মীরসরাই উপজেলার যেকোনো গ্রাহক ওয়েবসাইটে অনলাইন অর্ডার করলে সম্পূর্ণ ফ্রি হোম ডেলিভারি পাবেন।' },
          { q: 'বিগ বাজারের "বিয়ের সাজনি" সেকশনে কী কী পাওয়া যায়?', a: 'বিয়ের সাজনি সেকশনে কনের জন্য কারচুপি জামদানি, কাতান, জর্জ্রেট, সারারা, গারারা এবং বরের জন্য শেরওয়ানি, প্রিমিয়াম পাঞ্জাবি ও ব্লেজারের সম্পূর্ণ ব্রাইডাল সেট পাওয়া যায়।' },
          ...
          { q: 'ডেলিভারি চার্জ কত এবং কীভাবে পেইড করব?', a: 'মীরসরাই উপজেলায় ফ্রি ডেলিভারি, চট্টগ্রামের অন্যান্য এলাকায় ১০০ টাকা এবং চট্টগ্রাম বিভাগের বাইরে ১৫০ টাকা। অর্ডার কনফার্মেশনের জন্য ডেলিভারি চার্জ অগ্রিম প্রদান করতে হয় এবং বাকি টাকা ক্যাশ অন ডেলিভারি (COD) এর মাধ্যমে পণ্য হাতে পেয়ে পরিশোধ করা যাবে। (বিশেষ দ্রষ্টব্য: পণ্যের ওজনের ওপর ভিত্তি করে কিছু ক্ষেত্রে ডেলিভারি চার্জ বাড়তে পারে; চার্জ বেশি হলে অর্ডার কনফার্মেশনের সময় গ্রাহককে জানিয়ে দেওয়া হবে)।' }
        ].map((item, idx) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl space-y-2">
            ...
            <p className="text-zinc-500 text-xs leading-relaxed font-medium">
              মীরসরাই উপজেলায় ফ্রি ডেলিভারি (অর্ডার কনফার্মেশন ফি ১০০ টাকা অগ্রিম প্রযোজ্য যা মোট বিল থেকে বাদ যাবে) এবং চট্টগ্রামের অন্যান্য এলাকায় ডেলিভারি চার্জ ১০০ টাকা। ১ থেকে ২ কার্যদিবসের মধ্যে হোম ডেলিভারি পাওয়া যাবে।
            </p>
          </div>
          <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl space-y-2">
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-xs md:text-sm text-zinc-500 leading-relaxed font-medium">
          <p>
            <strong className="text-zinc-800">ব্যক্তিগত তথ্য সংগ্রহ:</strong> আমরা শুধুমাত্র কাস্টমারের নাম, ফোন নম্বর, ডেলিভারির ঠিকানা এবং বিশেষ অর্ডার নোট সংগ্রহ করি যা পণ্যটি আপনার কাছে সফলভাবে পৌঁছে দিতে প্রয়োজন।
          </p>
          <p>
            <strong className="text-zinc-800">তথ্য ব্যবহার:</strong> কোনো অবস্থাতেই আপনার এই তথ্য বা ফোন নম্বর আমরা অন্য কোনো তৃতীয় পক্ষ বা মার্কেটিং এজেন্সির কাছে বিক্রি বা লিক করি না।
          </p>
          <p>
            <strong className="text-zinc-800">পেমেন্ট সিকিউরিটি:</strong> বিকাশ বা নগদে পেমেন্ট করার সময় তা সম্পূর্ণ সুরক্ষিত ও থার্ড-পার্টি অথেনটিকেটেড গেটওয়ে দিয়ে প্রসেস করা হয়।
          </p>
        </div>
      </div>
    )
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl mt-4 space-y-4 text-xs md:text-sm text-zinc-500 leading-relaxed font-medium">
          <p>
            <strong className="text-zinc-800">প্রক্রিয়া:</strong> রিফান্ড আবেদন যাচাই এবং সত্যতা পাওয়ার পরবর্তী ৩ থেকে ৫ কার্যদিবসের মধ্যে আপনার ব্যবহৃত বিকাশ, নগদ অথবা ব্যাংক অ্যাকাউন্টে সম্পূর্ণ মূল্য ফেরত পাঠিয়ে দেওয়া হবে।
          </p>
        </div>
      </div>
    )

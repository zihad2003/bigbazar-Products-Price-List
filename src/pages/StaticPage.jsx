    ...
    content: (
      <div className="space-y-6">
        {[
          ...
          { q: 'ডেলিভারি চার্জ কত এবং কীভাবে পেইড করব?', a: 'মীরসরাই উপজেলায় ফ্রি ডেলিভারি, চট্টগ্রামের অন্যান্য এলাকায় ৬০ টাকা এবং চট্টগ্রাম বিভাগের বাইরে ১২০ টাকা। ক্যাশ অন ডেলিভারি (COD) এর মাধ্যমে ডেলিভারি ম্যানের কাছে পেমেন্ট করা যাবে।' }
        ].map((item, idx) => (
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="p-6 bg-zinc-50 border border-zinc-150 rounded-3xl space-y-2">
            <h4 className="text-zinc-900 font-bold text-sm">লোকাল শিপিং (চট্টগ্রাম মেট্রো)</h4>
